...
export default function Edit({ commodity }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('commodities.update', commodity.id));
    };

    return (
        <Sidebar header={<h2 className="text-xl font-semibold text-gray-800">Edit Commodity</h2>}>
            <Head title="Edit Commodity" />
