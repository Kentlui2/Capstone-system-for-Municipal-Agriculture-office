    ...
    return (
        <div>
            ...
            {selected.map((row, index) => (
                <div key={index} className="mb-3 flex items-end gap-3 rounded-lg border border-gray-200 bg-gray-50 p-3">
                    <div>
                        ...
                        <div key={field.key}>
                            ...
                            {field.type === 'select' ? (
                                ...
                                <input
                                    ...
                                    value={row[field.key] || ''}
                                    onChange={(e) => updateRow(index, field.key, e.target.value)}
                                    className="mt-1 w-32 rounded-lg border-gray-300 text-sm"
                                />
                            )}
                        </div>
                    ))}
